...
\title{\textbf{Explicit Construction and Spectral Analysis of the 2D Dirac Operator on the Right Conoid: Rigorous Foundations, Normalizability, and Self-Adjointness}}
...
\begin{abstract}
We provide a fully explicit and mathematically rigorous construction of the 2D Dirac operator on the right conoid manifold in the SAM3 framework. This includes the orthonormal frame, spin connection, matrix form of the operator, proof of essential self-adjointness, detailed analysis of normalizability of the lightest modes via weighted Sobolev spaces and the Dual-Zero regulator, verification of compact resolvent in the regularized theory, boundary conditions, and explicit confirmation that \(D^2\) reproduces the Laplace--Beltrami operator plus curvature terms. These results directly address foundational peer-review concerns for the spectral triple.
\end{abstract}

\section{Introduction}
The 2D Dirac operator is the central analytic object in the SAM3 construction. This paper supplies the explicit construction, numerical spectrum, boundary conditions, and — crucially — the rigorous functional-analytic treatment of domain, self-adjointness, and regularized normalizability.

% === Inserted rigorous sections here ===
...
% (You can insert the original numerical spectrum and boundary conditions sections here if desired)
...
\begin{theorem}[Regularized Normalizability and Compact Resolvent]
...
Full details and explicit constants are in the supplementary notebook (to be added to \texttt{code/verification/}).
...
\section{Conclusion}
[Add a short concluding paragraph linking to the full spectral triple and next papers.]

\bibliographystyle{plain}
\bibliography{references}  % Create a references.bib if needed
